...
public interface IKeycloakAdminService
{
    ...
    Task UpdateUserAsync(string identityId, string username, string email, string firstName, string lastName, bool enabled, CancellationToken cancellationToken = default);
    ...
    Task EnableEditUsernameAsync(CancellationToken cancellationToken = default);
    Task ConfigureClientRedirectsAsync(string clientId, CancellationToken cancellationToken = default);
}
