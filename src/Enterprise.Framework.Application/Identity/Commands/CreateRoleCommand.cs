...
public record CreateRoleCommand : IRequest<long>, ITransactionalRequest {
...
_context = context;
 ...
 async Task<long> Handle(CreateRoleCommand request, CancellationToken cancellationToken) {
...
_logger.LogCritical(ex,
                "Role '
RoleName}
' saved locally but Keycloak sync failed. " +
