...
public sealed record AssignPermissionToRoleCommand(long RoleId, long PermissionId) : IRequest<Unit>;
...
class AssignPermissionToRoleCommandHandler : IRequestHandler<AssignPermissionToRoleCommand, Unit>
{
