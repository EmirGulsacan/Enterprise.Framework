...
public sealed record AssignRoleToUserCommand(long UserId, long RoleId) : IRequest<Unit>;
...
class AssignRoleToUserCommandHandler : IRequestHandler<AssignRoleToUserCommand, Unit>
{
