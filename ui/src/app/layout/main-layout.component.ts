    ...
    <div class="layout-wrapper">
      <div class="layout-sidebar">
        ...
        <nav class="px-3 mt-4">
          ...
          <div class="text-white-alpha-40 text-xs font-bold mb-3 px-3 mt-4 uppercase tracking-widest">Yönetim</div>
          <ul class="list-none p-0 m-0 flex flex-column gap-2">
            <li>
            ...
            <li>
              <a routerLink="/management/organization" routerLinkActive="active" class="nav-link">
